...
.fin-kpi.p{border-top:3px solid #7C3AED}.fin-kpi.g{border-top:3px solid #16A34A}
...
.fin-card.paga{border-left:3px solid #16A34A;background:#F0FDF4}
.fin-card.pendente{border-left:3px solid #D97706}
...
.cons-block{background:#F7F8FC;border:1px solid #E4E7EF;border-radius:12px;
            padding:16px;margin-bottom:12px}
.cons-title{font-weight:700;font-size:15px;color:#1A1F2E;margin:0 0 12px}
.form-row{display:flex;align-items:center;gap:8px;padding:8px 0;
          border-bottom:1px solid #E4E7EF;font-size:13px}
.form-row:last-child{border-bottom:none;padding-bottom:0}
.form-name{flex:1;color:#1A1F2E;font-weight:500}
.form-fat{font-size:12px;color:#8B94A3}
.nh-row{display:flex;align-items:center;gap:10px;padding:12px 14px;
        background:#fff;border:1px solid #E4E7EF;border-radius:10px;margin-bottom:8px}
.nh-row.nh-paga{border-left:3px solid #16A34A;background:#F0FDF4}
.nh-row.nh-pendente{border-left:3px solid #D97706}
</style>
"""
